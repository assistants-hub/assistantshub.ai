...
import { getPrimaryColor } from '@/app/utils/assistant';
...
export default function ChatPopupFrame(props: ChatPopupFrameProps) {
  ...
  return (
    <div
      className={
        'border-[ relative m-2 flex max-h-full max-w-md flex-auto justify-center rounded-lg border-2 bg-white' +
    ...
    >
      ...
      ></div>
      <div className={'flex flex-col space-y-4 p-2 md:min-w-max'}>
        <ChatHeader
          minimize={props.hide}
